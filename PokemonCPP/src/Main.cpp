...
int main(int argc, char* argv[]) 
{
	...
	srand(unsigned int(time(NULL))); // Gotta seed that random

	// If parameter detected, use that language
    if (argc >= 2) {
	...
	Mix_VolumeMusic(MIX_MAX_VOLUME/4); // music is loud...
